    ...
    return (
        <DocPage>
            ...
            <div className="rounded-sm border border-n-1 bg-purple-1 p-5">
                <p className="text-[11px] font-bold uppercase tracking-wide text-n-1/70">Design System · Live Audit</p>
                <h1 className="mt-1 text-h4">What the app actually uses</h1>
                <p className="mt-2 text-sm font-bold text-n-1">
                    ~916 distinct implementations → ~138 canonical (−85%). Every row carries its real grep usage count;
                    items used nowhere are labeled <span className="rounded bg-n-1/10 px-1">DEAD</span>.
                </p>
