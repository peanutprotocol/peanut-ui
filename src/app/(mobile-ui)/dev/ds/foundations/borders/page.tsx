...
export default function BordersPage() {
    return (
        <DocPage>
            <DocHeader title="Borders" description="Border radius and semantic border styles." />

            {/* Border radius */}
            <DocSection title="Border Radius">
                <p className="text-body-s text-foreground-secondary">
                    Always use <code className="font-mono text-label-m text-foreground-primary">rounded-sm</code>. This
                    is the standard across all components.
                </p>
            ...
            <DocSection title="Border Styles">
                <DocSection.Content>
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="rounded-sm border-2 border-border-default p-4 text-label-m">
                ...
                <DocSection.Code>
                    ...
                    />
                    <CodeBlock
                        label="border-2 border-border-default"
                        code='className="rounded-sm border-2 border-border-default"'
                    />
                </DocSection.Code>
            </DocSection>
        </DocPage>
