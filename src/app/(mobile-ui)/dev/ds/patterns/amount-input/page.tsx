            ...
            <DocSection title="Visual Structure">
                <DocSection.Content>
                    <div className="rounded-sm border border-n-1 p-4">
                        ...
                        <div className="absolute right-4 top-1/2 -translate-y-1/2 text-grey-1">
                        </div>
                    </div>
                ...
                <DocSection.Code>
                    ...
                    <CodeBlock label="Basic (USD only)" code={`<AmountInput
  setPrimaryAmount={setAmount}
  primaryDenomination={{ symbol: '$', price: 1, decimals: 2 }}
/>`} />

                    <CodeBlock label="With conversion" code={`<AmountInput
...
/>`} />
                    ...
                    <CodeBlock label="With slider (Pot contributions)" code={`<AmountInput
  setPrimaryAmount={setAmount}
  primaryDenomination={{ symbol: '$', price: 1, decimals: 2 }}
  showSlider
  maxAmount={potMax}
...
/>`} />
            ...
            <DocSection title="Props">
                <PropsTable
                    rows={[
                        { name: 'setPrimaryAmount', type: '(value: string) => void', default: '-', required: true, description: 'Callback for the primary denomination amount' },
