        ...
        <DocPage>
            ...
            <DocSection title="StatusBadge">
                <DocSection.Content>
                    ...
                    <PropsTable
                        rows={[
                            { name: 'status', type: 'StatusType', default: '-', required: true, description: 'completed | pending | processing | failed | cancelled | refunded | soon | closed | custom' },
                            { name: 'size', type: "'small' | 'medium' | 'large'", default: "'small'" },
                            { name: 'customText', type: 'string', default: '(none)', description: 'Text when status="custom"' },
                            { name: 'className', type: 'string', default: "''", description: 'Override styles' },
                        ]}
                    />
                </DocSection.Content>
                <DocSection.Code>
                    <CodeBlock label="Import" code={`import StatusBadge from '@/components/Global/Badges/StatusBadge'`} />

                    <CodeBlock label="Usage" code={`<StatusBadge status="completed" />
...
<StatusBadge status="custom" customText="Active" />`} />
            ...
            <DocSection title="StatusPill">
                <DocSection.Content>
                    ...
                    <PropsTable
                        rows={[
                            { name: 'status', type: 'StatusPillType', default: '-', required: true, description: 'Same as StatusType but excludes "custom"' },
                        ]}
                    />
                </DocSection.Content>
                <DocSection.Code>
            ...
            <DocSection title="ErrorAlert">
                <DocSection.Content>
                    ...
                    <PropsTable
                        rows={[
                            { name: 'description', type: 'string', default: '-', required: true, description: 'Error message text' },
                            { name: 'className', type: 'string', default: "''", description: 'Override container styles' },
                            { name: 'iconSize', type: 'number', default: '16' },
                            { name: 'iconClassName', type: 'string', default: "''", description: 'Override icon styles' },
                        ]}
                    />
                </DocSection.Content>
                <DocSection.Code>
                    ...
                    <CodeBlock label="Usage" code={`<ErrorAlert description="Something went wrong. Please try again." />`} />
                </DocSection.Code>
            </DocSection>
            ...
            <DocSection title="EmptyState">
                <DocSection.Content>
                    ...
                    <PropsTable
                        rows={[
                            { name: 'icon', type: 'IconName', default: '-', required: true, description: 'Icon shown in pink circle' },
                            { name: 'title', type: 'string | ReactNode', default: '-', required: true },
                            { name: 'description', type: 'string', default: '(none)' },
                            { name: 'cta', type: 'ReactNode', default: '(none)', description: 'Action button below text' },
                            { name: 'containerClassName', type: 'string', default: "''", description: 'Override Card container' },
                        ]}
                    />
                </DocSection.Content>
                <DocSection.Code>
                    <CodeBlock label="Import" code={`import EmptyState from '@/components/Global/EmptyStates/EmptyState'`} />

                    <CodeBlock label="Usage" code={`<EmptyState
  icon="wallet"
  title="No transactions yet"
...
/>`} />
            ...
            <DocSection title="NoDataEmptyState">
                <DocSection.Content>
                    ...
                    <PropsTable
                        rows={[
                            { name: 'message', type: 'string', default: '-', required: true, description: 'Text below the animation' },
                            { name: 'cta', type: 'ReactNode', default: '(none)', description: 'Action below message' },
                            { name: 'animSize', type: "'sm' | 'md' | 'lg' | 'xl'", default: "'sm'", description: '96 / 128 / 192 / 256 px' },
                        ]}
                    />
                </DocSection.Content>
                <DocSection.Code>
                    <CodeBlock label="Import" code={`import NoDataEmptyState from '@/components/Global/EmptyStates/NoDataEmptyState'`} />
