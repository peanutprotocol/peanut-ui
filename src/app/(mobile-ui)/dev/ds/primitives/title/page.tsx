        ...
        <DocPage>
            ...
            <PropsTable
                rows={[
                    { name: 'text', type: 'string', default: '(required)', required: true },
                    {
                        ...
                        type: 'boolean',
                        default: 'true',
                        description: 'Horizontal offset for shadow effect',
                    },
                ]}
            />
            ...
            <DocSection title="Examples">
                ...
                <DocSection.Code>
                    ...
                    <CodeBlock label="Default" code={`<Title text="PEANUT" />`} />
                    <CodeBlock label="Without Offset" code={`<Title text="NO OFFSET" offset={false} />`} />
                </DocSection.Code>
            </DocSection>
        </DocPage>
    )
