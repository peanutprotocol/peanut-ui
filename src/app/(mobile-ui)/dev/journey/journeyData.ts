...
export const IN_APP_SURFACES: InAppSurface[] = [
    ...
    },
    {
        ...
        condition: "step=outbound && !canApplyForCard — QR-only framing, never teases a card they can't get",
        sourceFile: 'src/components/Home/ActivationCTAs.tsx',
        states: ['kycd-no-card'],
    },
    {
        ...
        condition: 'step=outbound && canApplyForCard — card spend counts as activation too (TASK-20471)',
        sourceFile: 'src/components/Home/ActivationCTAs.tsx',
