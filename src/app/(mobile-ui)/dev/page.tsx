...
export default function DevToolsPage() {
    ...
    const tools: { name: string; description: string; path: string; icon: IconName; static?: boolean }[] = [
        ...
        {
            name: '1337 Squ1rr3l Squ4d',
            description:
                'Hacker training grounds: the funnel-definitions quiz (Lexicon, levels, points, share card). Single static HTML in public/ — zero build impact.',
            path: '/dev-quiz/index.html',
            icon: 'trophy',
            static: true,
        },
        {
