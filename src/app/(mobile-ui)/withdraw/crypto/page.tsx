                ...
                description={
                    <div className="space-y-2">
                        ...
                        {!!withdrawData?.address && (
                            <p>
                                {t.rich('compatibilityModal.sendingTo', {
                                    address: printableAddress(withdrawData.address),
                                    mono: (chunks) => (
                                        <span className="font-mono font-medium text-n-1 dark:text-white">{chunks}</span>
                                    ),
                                })}
                            </p>
                        )}
