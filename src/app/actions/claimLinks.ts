 ...
 * It sends passwords to the backend which is a security vulnerability.
 *
 * Use SDK's claimLinkGasless() instead, which signs transactions client-side.
 * See: useClaimLink hook for proper implementation.
 *
 * This function is kept only for backward compatibility and will be removed soon.
 */
export async function claimSendLink(
    ...
    console.warn('⚠️ DEPRECATED: claimSendLink() sends passwords to backend. Use SDK claimLinkGasless() instead.')
