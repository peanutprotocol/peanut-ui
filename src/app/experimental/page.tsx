                        ...
                        <div className="border-2 border-black lg:grid lg:grid-flow-col-dense lg:grid-cols-2 ">
                            ...
                            <div className="brutalborder bg-white py-16 text-center sm:px-6 lg:mx-0 lg:max-w-none lg:px-0">
                                ...
                                <div className="m-4 mx-auto w-3/4 p-2 text-xl">
                                    This is an experimental feature where you can claim Peanut link on your preferred
                                    chain and in your preferred token. This is pre-release, we'd love to work together
                                    with you to make this awesome.
                                </div>
                ...
                <section className="h-full w-full bg-white py-12 text-black">
                    <div className="center-xy mx-auto flex w-11/12 items-center bg-white lg:w-3/5">
                        <div className="text-center">
                            <h2 className="title-font text-3xl font-black text-black lg:text-7xl">Build with us!</h2>

                            <div className="mx-auto w-4/5 p-5 text-xl lg:w-2/3">
                                Thanks for helping us! We're always keen on hearing new ideas or getting feedback. Maybe
                                something did not work properly or you have an idea for an awesome integration. Let's
                                chat about!
                            </div>
                            ...
                            <a href="https://discord.gg/kVZqXDkrq7" target="_blank" rel="noopener noreferrer">
                                <button
                                    id="cta-btn"
                                    className="cta m-10 bg-white px-3 text-2xl font-black hover:underline"
                                >
                                    Join our community →
                                </button>
                            </a>
