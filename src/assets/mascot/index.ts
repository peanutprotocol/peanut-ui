// Canonical home for the static Peanut mascot assets.
// Animated mascots live behind the pose-based PeanutMascot component.
...
export { default as PEANUT_SITTING } from './peanut-sitting.webp'
