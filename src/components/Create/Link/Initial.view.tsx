        ...
        <div className="flex w-full flex-col items-center justify-center gap-6 text-center">
            ...
            {inputValue.length > 0 ? (
                ...
                (recentRecipients.length > 0 ? (
                    <div className="flex w-full flex-col items-start  justify-center gap-2">
                        <label className="text-h7 font-bold text-n-2">Recents</label>
                        {recentRecipients.map((recipient) => (
                            ...
                            >
                                <div className="flex w-full flex-row items-center justify-between overflow-hidden text-h7">
                                    ...
                                    <label className="font-normal text-n-2">
                                        {' '}
                    ...
                    <div className="flex w-full flex-col items-start  justify-center gap-2">
                        <label className="text-h7 font-bold text-n-3">Recents</label>
                        {[0, 1, 2].map((idx) => (
                            <div
                                key={idx}
                                className="border-rounded flex h-12 w-full flex-row items-center justify-between p-2"
                            >
                                <div className="flex w-full flex-row items-center justify-between overflow-hidden text-h7">
                                    <div className="flex flex-row items-center justify-start gap-2">
