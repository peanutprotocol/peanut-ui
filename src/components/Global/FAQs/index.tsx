    ...
    return (
        ...
        >
            <Box className="relative px-6 py-20 md:px-8 md:py-36">
                ...
                >
                    <h2 className="absolute -left-6 -top-8 rounded-full border-2 border-n-1 bg-primary px-5 py-3 font-display text-[1.5rem] font-bold text-white shadow ring-2 ring-white md:text-[2rem]">
                        {heading}
                    </h2>
