...
// 24x24 viewBox already matches the rest of the icon set; let outer <Icon>
// control width/height instead of pinning them here.
export const DoubleCheckIcon: FC<SVGProps<SVGSVGElement>> = ({ fill, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fill ?? 'currentColor'} {...props}>
