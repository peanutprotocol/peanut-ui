        ...
        >
            <div className="flex flex-col h-full gap-2 p-0 sm:p-2">
                <div className="w-full sm:hidden">
                    {showCloseConfirmMessage ? areYouSurePromptRow : <button className="btn-purple w-full rounded-none" onClick={() => {
                        setShowCloseConfirmMessage(true)
                    }}>
                        CLOSE
                    </button>}
                ...
                <div className="hidden sm:flex flex-row w-full items-center">
                    {showCloseConfirmMessage ? areYouSurePromptRow : <button className="btn-purple w-full" onClick={() => {
                        setShowCloseConfirmMessage(true)
                    }}>
                        Close
                    </button>}
