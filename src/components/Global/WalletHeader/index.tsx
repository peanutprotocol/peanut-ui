                    ...
                    <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            {isPeanutWallet && username ? (
                                ...
                                <p className="text-xs font-medium">{primaryName || shortenAddressLong(wallet.address)}</p>
                            )}
                            <CopyToClipboard
                                className="h-4 w-4"
                                fill={'black'}
                                textToCopy={
                                    isPeanutWallet && username ? `https://peanut.me/${username}` : (primaryName || wallet.address)
                                }
                            />
                        </div>
                        {isConnected && (
