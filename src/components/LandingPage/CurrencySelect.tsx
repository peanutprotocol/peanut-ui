            ...
            >
                <div className="flex w-full flex-col gap-4 p-4">
                    ...
                    <div className="flex w-full flex-col items-start">
                        ...
                        <CurrencyBox />
                        <CurrencyBox /> <CurrencyBox selected />
                    </div>
                </div>
            </PopoverContent>
        </Popover>
...
const CurrencyBox = ({ selected }: { selected?: boolean }) => {
    return (
        <div
            className={twMerge(
        ...
        >
            <div className="flex items-center gap-2">
                <h3 className="text-base font-bold">EUR</h3>
                <span className="text-xs font-medium text-gray-1">Euro</span>
            </div>
