            ...
            <div className={`mx-auto mb-4 ${PROSE_WIDTH} px-6 md:px-4`}>
                <div className="flex flex-wrap gap-2">
                    <button
                        ...
                        className={`${chipBase} ${activeType === null ? 'bg-action-primary/20' : 'hover:bg-primary-3/30'}`}
                    >
                        {strings.filterAll}
                    </button>
                    {TYPE_VALUES.map((t) => (
                        <button
                            ...
                            className={`${chipBase} ${activeType === t ? 'bg-action-primary/20' : 'hover:bg-primary-3/30'}`}
                        >
                            {typeLabels[t]}
                        </button>
                    ))}
