        ...
        <div className="space-y-4">
          ...
          <div className="flex w-full flex-col items-center">
            <button
              ...
              className={`flex w-full items-center justify-center px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-opacity-50 ${isKernelClientReady && !isSendingUserOp
