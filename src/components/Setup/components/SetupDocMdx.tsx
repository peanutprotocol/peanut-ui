...
/** Compact article typography for the setup drawer. Content still comes from
 * the same MDX files as the public legal and help pages. */
export const createSetupDocComponents = (locale: Locale): ReturnType<typeof createMdxComponents> => ({
