 ...
 * Green circle background with star icon at consistent proportions
 */
export const PerkIcon: React.FC<PerkIconProps> = ({ size = 'medium', className = '' }) => {
    ...
    return (
        <div
            className={`flex ${config.container} flex-shrink-0 items-center justify-center rounded-full bg-background-icon-bubble-green ${className}`}
        >
