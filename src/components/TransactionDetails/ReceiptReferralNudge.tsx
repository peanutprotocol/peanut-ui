...
export function ReceiptReferralNudge({
    ...
    return (
        ...
        <ShareButton
            ...
            className="relative h-auto gap-2 p-0 text-body-s text-foreground-secondary underline shadow-none after:absolute after:inset-x-0 after:-inset-y-3.5 hover:text-foreground-primary active:text-foreground-primary"
        >
