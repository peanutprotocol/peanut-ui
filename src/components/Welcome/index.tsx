...
const testimonials = [
    ...
    {
        imageSrc: assets.KOFIME_LOGO.src,
        altText: 'kofi',
    ...
    {
        imageSrc: assets.KOFIME_LOGO.src, // TODO: replace with actual image@
...
export function Welcome() {
    ...
    return (
        <div className="flex w-full flex-col items-center justify-center gap-4 bg-white  dark:bg-black ">
            ...
            <div className="grid grid-cols-1 gap-4  p-4 text-black  lg:grid-cols-3">
                <label className="flex items-center justify-center bg-pink-1 p-4 text-center text-h3 font-black sm:px-16">
                    300k+ Transactions
                </label>

                <label className="flex items-center justify-center bg-yellow-1 p-4 text-center text-h3 font-black sm:px-16">
                    105k+ Unique wallet addresses
                </label>

                <label className="flex items-center justify-center bg-green-1 p-4 text-center  text-h3 font-black sm:px-16">
                    20+ Chains
                </label>
            </div>

            <div className="flex w-full flex-col items-center justify-between bg-yellow-1 lg:flex-row-reverse ">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-8 px-8 text-center">
            ...
            <div className="flex w-full flex-col items-center justify-between bg-yellow-1 lg:flex-row ">
                <div className="relative flex items-center justify-center px-8 lg:h-1/3 lg:w-1/3">
                ...
                <div className="flex w-full flex-col items-center justify-center gap-8 px-8 text-center">
                    ...
                    <div className="w-3/4 text-h5 font-normal ">
                        Forget chains and wallet addresses. Do a peer 2 peer transfer with a trustless payment link, no
                        matter whether the recipient has a wallet.{' '}
                    </div>
            ...
            {/* <Disclosure>
                {faqs.map((faq, index) => {
                    return (
                        <div
                            key={index}
                            className="brutalborder-y grid grid-cols-1 gap-4 overflow-hidden bg-white p-4 text-black md:grid-cols-3 sm:mx-0 sm:grid-cols-2"
                        >
                            <Disclosure.Button className="brutalborder flex flex-col border-2 border-black p-4 text-center sm:p-12 sm:px-16">
                                <h3 className="mb-4 text-5xl font-black">{faq.question}</h3>
                            </Disclosure.Button>
                            
                            <Disclosure.Panel className="text-gray-500">{faq.answer}</Disclosure.Panel>
                        </div>
                    )
                })}
            </Disclosure> */}
