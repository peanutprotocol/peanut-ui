    ...
    return (
        <div className=" flex w-full flex-col items-center justify-center">
            <div className="relative">
                ...
                <div className="space-y-8 py-8 sm:space-y-12 sm:py-16 md:space-y-24 md:py-20 lg:space-y-28 lg:py-24">
                    <div className="relative flex w-full text-black dark:text-white">
                        <motion.img
                            ...
                            transition={{ type: 'spring', damping: 5 }}
                            src={Star.src}
                            className="absolute left-[2%] top-[7%] w-12 md:left-[5%] md:top-[10%] lg:left-[5%] lg:top-[10%]"
                        />
                        <motion.img
                            initial={{ opacity: 0, translateY: 28, translateX: -5 }}
                            whileInView={{ opacity: 1, translateY: 0, translateX: 0 }}
                            transition={{ type: 'spring', damping: 5 }}
                            src={Star.src}
                            className="absolute right-[3%] top-[4%] w-12 md:right-[4%] md:top-[8%] lg:right-[4%] lg:top-[8%]"
                        />
                    ...
                    <div className="py-6- md:py-10- md:pb-20- lg:pb-30- flex w-full flex-wrap items-center gap-4 bg-transparent px-4">
                    ...
                    <div className="relative mx-5 flex flex-row flex-wrap items-center justify-center gap-4 gap-y-8 sm:gap-8">
