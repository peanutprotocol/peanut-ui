                ...
                <div className="relative mx-auto">
                    <div className="border-2 border-black lg:grid lg:grid-flow-col-dense lg:grid-cols-2 ">
                        ...
                        <div className="brutalborder bg-yellow py-16 text-center sm:px-6 lg:mx-0 lg:max-w-none lg:px-0">
                            <h1 className="mx-auto my-8 w-3/4 text-5xl font-black">Join the WELCOME!</h1>
                    ...
                    >
                        ...
                        <div className="center-xy flex-end my-6 flex justify-around">
                            ...
                            <a
                                ...
                                hidden
                            >
                                <button className="ml-4 p-5 text-2xl font-normal hover:underline">Case Study →</button>
                            </a>
                        </div>
                    </div>
                    {/* Email */}
                    ...
                    >
                        ...
                        <div className="center-xy flex-end my-6 flex justify-around">
                            ...
                            <a
                                ...
                                hidden
                            >
                                <div className="ml-4 p-5 text-2xl font-normal hover:underline">Testimonial →</div>
                            </a>
                        </div>
                    </div>
                    {/* Physical */}
                    ...
                    >
                        ...
                        <div className="center-xy flex-end my-6 flex justify-around">
                            ...
                            <a
                                ...
                                rel="noopener noreferrer"
                            >
                                <button className="ml-4 p-5 text-2xl font-normal hover:underline">Testimonial →</button>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <section className="h-full w-full bg-white py-12 text-black">
                <div className="center-xy mx-auto flex w-11/12 items-center bg-white lg:w-3/5">
                    <div className="text-center">
                        ...
                        <div className="mx-auto w-11/12 p-5 px-6 text-3xl lg:w-2/3">
                        ...
                        <a href="https://t.me/peanutprotocol" target="_blank" rel="noopener noreferrer">
                            <button className="p-5 text-2xl font-black hover:underline">Talk to an expert →</button>
                        </a>
                    </div>
                </div>
            </section>
