...
export const chainId = process.env.NEXT_PUBLIC_JUSTANAME_CHAIN_ID ? parseInt(process.env.NEXT_PUBLIC_JUSTANAME_CHAIN_ID) as ChainId : 1;
...
export const JustWeb3Provider: React.FC<JustaNameProviderConfig> = ({children}) => {
    return (
        <JustWeb3ProviderPrimitive config={justweb3Config}>
            {children}
        </JustWeb3ProviderPrimitive>
    )
}