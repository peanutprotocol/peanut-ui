 ...
 *    - one switch for every platform: web, iOS and Android read the same value
 *
...
const underMaintenanceConfig: MaintenanceConfig = {
    ...
    /**
     * Ops kill-switch for cross-chain withdrawals, on every platform. Currently
     * off: cross-chain is live on web, iOS and Android (stables via SDA,
     * non-stables via swaps, fee shown honestly). Set true to lock every
     * platform to USDC on Arbitrum.
     */
