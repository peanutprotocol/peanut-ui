...
export interface Translations {
    ...
    pressBrandTitle: string // "Brand & Assets"
    pressBrandSubtitle: string // "Logos, colours, type and product screenshots — everything you need to put Peanut on a page."
    pressBrandBackToPress: string // "← Back to the press kit"
    pressBrandTheMark: string // "The mark"
    pressBrandDo: string // "Do"
    pressBrandDont: string // "Don't"
    pressBrandDownloads: string // "Downloads"
    pressBrandPalette: string // "Colour"
    pressBrandTypography: string // "Type"
    pressBrandScreenshots: string // "Product screenshots"
